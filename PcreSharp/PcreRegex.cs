...
namespace PcreSharp
{
	public class PcreRegex : IDisposable
	{
        ...
        public PcreRegex(string pattern, PcreOptions options) : this(pattern, options, PcreStudyOptions.NONE)
	    {
	    }

	    public PcreRegex(string pattern) : this(pattern, PcreOptions.NONE, PcreStudyOptions.NONE)
	    {
	    }
        #endregion
